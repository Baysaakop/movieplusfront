...
import api from "../../../api"
import FilmCastModalCreate from "../Film/FilmCastModalCreate"
import FilmCastModalUpdate from "../Film/FilmCastModalUpdate"

const { Search } = Input
const { Option } = Select

function SeriesCast (props) {
    ...
    function getCast(id, page) {        
        const url = `${api.cast}?series=${id}&page=${page}`
        axios({
            method: 'GET',
            url: url,
            headers: {
