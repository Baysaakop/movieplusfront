...
import api from "../../../api"
import FilmCrewModalCreate from "../Film/FilmCrewModalCreate"
import FilmCrewModalUpdate from "../Film/FilmCrewModalUpdate"

const { Search } = Input
const { Option } = Select

function SeriesCrew (props) {
    ...
    function getCrew(id, page) {        
        const url = `${api.crew}?series=${id}&page=${page}`
        axios({
            method: 'GET',
            url: url,
            headers: {
