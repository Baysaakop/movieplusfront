...
import api from "../../../api"
import ReviewModalUpdate from "../../Film/Review/ReviewModalUpdate"

function SeriesReview (props) {
    ...
    function getScore () {
        let item = review.user.profile.series_scores.find(x => x.series === props.film.id)        
        if (item && item !== null) {
