    ...
    return (
        <div>
            <Carousel autoplay>
                ...
                <div>
                    <div style={{ position: 'relative', width: '100%', paddingTop: '50%', background: '#e74c3c' }}>
                        <div style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: 0, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div>
                    <div style={{ position: 'relative', width: '100%', paddingTop: '50%', background: '#3742fa' }}>
                        <div style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: 0, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div>
                    <div style={{ position: 'relative', width: '100%', paddingTop: '50%', background: '#2ed573' }}>
                        <div style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: 0, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
